...
- **Tests:** `Software/tools/api_test.py` (85 Prüfungen: Fehlerfälle, ungültiges JSON, Body 512/600 Byte, chunked, Toggle, 429,
  ...
  `Software/tools/ws_regress.py` (21 Prüfungen des WebSocket-Protokolls, zwei Verbindungen). Beide schalten kurz Ausgänge und
  senden `collar.beep`/`collar.vibe`, also nicht mit angeschlossenem Halsband oder Pumpe ausführen.
